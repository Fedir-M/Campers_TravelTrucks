// here filter = feature (in a maket)

export const vehicleEquipmentFilters = [
  { labelFilter: "AC", iconFilter: "icon-wind" },
  { labelFilter: "Automatic", iconFilter: "icon-diagram" },
...
export const vehicleTypeFilters = [
  { labelFilter: "Van", iconFilter: "icon-bi_grid-1x2" },
  { labelFilter: "Fully Integrated", iconFilter: "icon-bi_grid" },
  { labelFilter: "Alcove", iconFilter: "icon-bi_grid-3x3-gap" },
];
